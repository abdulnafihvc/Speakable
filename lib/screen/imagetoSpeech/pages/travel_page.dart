...
class _TravelPageState extends State<TravelPage>
  ...
  final Color _categoryColor = Colors.teal;
  ...
  final List<Map<String, String>> _sampleImages = [
    {'name': 'I need an auto', 'asset': 'assets/Travel-image/auto.png'},
    {
      'name': 'Where is the bus stop?',
      'asset': 'assets/Travel-image/bus_stop.png',
    },
    {
      'name': 'Go to the railway station.',
      'asset': 'assets/Travel-image/railway_station.png',
    },
    {'name': 'Can I get a taxi?', 'asset': 'assets/Travel-image/taxi.png'},
    {
      'name': 'Where is the metro station?',
      'asset': 'assets/Travel-image/metro.png',
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Icon(Icons.travel_explore, color: _categoryColor),
            const SizedBox(width: 12),
            Text(
              _category,
              style: TextStyle(
