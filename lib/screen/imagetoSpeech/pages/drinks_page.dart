...
class _DrinksPageState extends State<DrinksPage>
  ...
  final String _category = 'Drinks';
  final Color _categoryColor = Colors.blue;
  ...
  final List<Map<String, String>> _sampleImages = [
    {'name': 'I want water', 'asset': 'assets/Drinks-image/water.png'},
    {'name': 'Can I have coffee?', 'asset': 'assets/Drinks-image/coffee.png'},
    {'name': 'I would like tea', 'asset': 'assets/Drinks-image/tea.png'},
    {'name': 'I want juice', 'asset': 'assets/Drinks-image/juice.png'},
    {'name': 'Can I have milk?', 'asset': 'assets/Drinks-image/milk.png'},
  ];
